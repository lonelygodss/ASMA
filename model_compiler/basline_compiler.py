...
class BaselineCompiler(CompilerBase):
    """
    ...
    def _divide_activation(self, function: Function, compiled_model: CompiledModel):
        ...
        # Input tensor for distribution
        input_tensor_coords = base_coords.copy()
        input_tensor_coords['m'] = 1
        input_tensor_coords['i'] = 0
        input_tensor_coords['j'] = 0

        input_tensor_id = self._create_tensor_id(input_tensor_coords)
